...
#########################################################
CUDA_VISIBLE_DEVICES=0 python train_AHDE.py --batch_size 64 --encoder_size 180 --context_size 50 --encoderR_size 22 --num_layer 1 --hidden_dim 100  --num_layer_con 1 --hidden_dim_con 100 --embed_size 300 --use_glove 1 --lr 0.001 --num_train_steps 100000 --is_save 0 --graph_prefix 'ahde' --corpus 'nela18_whole'
